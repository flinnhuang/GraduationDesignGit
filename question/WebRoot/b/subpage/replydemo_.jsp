...
String hta = (String)request.getAttribute("cont2");
String htmlData = request.getAttribute("cont") != null ? (String)request.getAttribute("cont") : "";

String submittime = request.getAttribute("submittime") != null ? (String)request.getAttribute("submittime") : "";
request.removeAttribute("cont2");//移除销毁保存到attribute里的相应数据
request.removeAttribute("cont");
request.removeAttribute("submittime");
%>
<!doctype html>
<html>
<head>
