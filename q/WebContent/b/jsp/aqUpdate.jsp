...
<table  width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF">
	...
	<input name="systype" type="text" value="<%=qsystem%>" readonly="readonly"/>
	<div id="select_option1" class="option1">
		...
		%>
			<li class="td001" style="font-size: 13px;" onMouseMove="style.backgroundColor='#B4DBFE'"
	...
	<input class="selectlist" name="type" type="text" id="type" value="<%=qtype%>" readonly="readonly"/>
	<div id="select_option1" class="option1">
		<ul style="margin-left: -40px;margin-top: -1px;" >
			<li class="td001" style="font-size: 13px;" onMouseMove="style.backgroundColor='#B4DBFE'"
	...
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp紧急程度：	
			普通<input name="degree" type="radio" value="3" checked="checked"/>
			&nbsp急<input name="degree" type="radio" value="2"/>
			&nbsp特急<input name="degree" type="radio" value="1"/>
	...
	<jsp:include page="demoForAqUpdate.jsp" flush="true"/>
	</td>
	</tr>
<tr>
<td align="left">
