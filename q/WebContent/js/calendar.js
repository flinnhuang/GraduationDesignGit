...
function PopupWindow_showPopup(anchorname,formName){
if(document.all){
 (theForm = (formName != null) ? document.forms[formName] : document.forms[0]);
 	toggleForm(theForm,0);
 }
...
if(arguments.length>0){
 ...
 c.offsetX = -154;
 c.offsetY = (navigator.appName.indexOf("Netscape") != -1) ? 1 : 20;c.autoHide();
 
 c.monthNames = new Array('1M','2M','3M','4M','5M','6M','7M','8M','9M','10M','11M','12M');
...
function CP_select(inputobj, linkname, format, formName){
...
if(selectedDate!=null){
 ...
 this.showCalendar(linkname,formName);
}
