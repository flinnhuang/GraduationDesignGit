 ...
 *
 */
public class preparedStatement implements PreparedStatement {
	 ...
	 * query string <code>sql</code> using the specified
	 * <code>connection</code> by calling
	...
	private preparedStatement(Connection connection, String sql)
			throws SQLException {
	...
	public static preparedStatement newInstance(Connection connection,
	...
	private preparedStatement(Connection connection, String sql,
		...
		wrappedStatement = connection.prepareStatement(sql, columnIndexes);
		sqlTemplate = sql;
		parameterValues = new ArrayList();
	}
	...
	public static preparedStatement newInstance(Connection connection,
		...
		return new preparedStatement(connection, sql, columnIndexes);
	}
	...
	public static preparedStatement newInstance(Connection connection,
		...
		return new preparedStatement(connection, sql, autoGeneratedKeys);
	}

	private preparedStatement(Connection connection, String sql,
			int resultSetType, int resultSetConcurrency, int resultSetHoldabilit)
			throws SQLException {
		wrappedStatement = connection.prepareStatement(sql, resultSetType,
				resultSetConcurrency, resultSetHoldabilit);
		sqlTemplate = sql;
		parameterValues = new ArrayList();
	}
	...
	public static preparedStatement newInstance(Connection connection,
			...
			int resultSetHoldabilit) throws SQLException {
		return new preparedStatement(connection, sql, resultSetType,
				resultSetConcurrency, resultSetHoldabilit);
	}
	...
	public static preparedStatement newInstance(Connection connection,
		...
		return new preparedStatement(connection, sql, columnNames);
	}
	...
	public void setDate(int parameterIndex, java.util.Date x)
			throws java.sql.SQLException {
		if (x != null) {
			wrappedStatement.setDate(parameterIndex, new java.sql.Date(x
					.getTime()));
		} else {
			wrappedStatement.setDate(parameterIndex, null);
		}
		saveQueryParamValue(parameterIndex, x);
	}
	 ...
	 * or REF parameter. In the case of a user-named type the name is the type
	 ...
	 * Blob, Clob, Struct, or Array, then the driver should pass it to the
	 ...
	 * custom timezone and locale. If no <code>Calendar</code> object is
